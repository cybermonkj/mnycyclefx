          ...
          <?php echo csrf_field(); ?>
           <div class="form-group row">
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-success btn-block"><?php echo e(__('Proceed')); ?></button>
            </div>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/new/core/resources/views/user/fund/bank.blade.php ENDPATH**/ ?>