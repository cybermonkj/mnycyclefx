                                        ...
                                        <div class="">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <?php if($val->status==1): ?>
                                                        <a class='dropdown-item' href="<?php echo e(route('sand.category.unpublish', ['id' => $val->id])); ?>"><?php echo e(__('Disable')); ?></a>
                                                    <?php else: ?>
                                                        <a class='dropdown-item' href="<?php echo e(route('sand.category.publish', ['id' => $val->id])); ?>"><?php echo e(__('Enable')); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div> 
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/new/core/resources/views/admin/project/category.blade.php ENDPATH**/ ?>